...
int main(int argc, char** argv){
    ...
    ExtractCoincidenceCompTree *extracter = new ExtractCoincidenceCompTree();
...
void DescribeInputParameters(){
    cout << "1 : camera1 rootfilename (including cetree)" << endl;
    cout << "2 : camera2 rootfilename (including cetree)" << endl;
